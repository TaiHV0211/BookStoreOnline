...
namespace OnlineMarket.Areas.Admin.Controllers
{
    ...
    public class AdminLocationsController : Controller
    {
        ...
        public AdminLocationsController(OnlineShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("LocationId,Name,Type,Slug,NameWithType,ParentCode,Levels")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LocationId,Name,Type,Slug,NameWithType,ParentCode,Levels")] Location location)
        {
